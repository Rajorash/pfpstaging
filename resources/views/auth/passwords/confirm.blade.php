        ...
        <div class="flex flex-wrap  justify-center">
            <div class="md:w-2/3 pr-4 pl-4">
                <div
                    ...
                    <div
                        class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900">{{ __('Confirm Password') }}</div>
                            ...
                            <div class="mb-4 flex flex-wrap  mb-0">
                                <div class="md:w-2/3 pr-4 pl-4 md:mx-1/3">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline font-normal text-blue bg-transparent"
